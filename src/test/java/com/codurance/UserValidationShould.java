...
public class UserValidationShould {
    ...
    private static final User USER_WITH_VALID_EMAIL = new User(1, "toby", "retallick", "toby@codurance.com"); //too many parameters?
...
//    @Test public void
//    check_if_a_user_has_a_valid_email() {
//        assertThat(userValidation.returnValidityOf(USER_WITH_INVALID_EMAIL), is(false));
//        assertThat(userValidation.returnValidityOf(USER_WITH_VALID_EMAIL), is(true));
//    }
}
